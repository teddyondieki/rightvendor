        ...
        <div class="panel-heading">
            <h3 class="panel-title">
                ...
                <ul class="nav nav-pills">
                    <li class="active"><a>1: Create account</a></li>
                    <li><a>2: Fill business information</a></li>
                </ul>
            </h3>
        </div>
...
//    ),
            ...
            <?php echo CHtml::submitButton('Next', array('class' => 'btn btn-lg btn-default text-uppercase btn-block')); ?>
